...
function InfoMessage({ message, status }: InfoMessageProps) {
  ...
  return (
    <div
      className={`absolute w-[300px] text-center z-50 left-1/2 transform -translate-x-1/2 px-6 py-2 rounded-xl text-2xl text-white shadow-lg transition-all duration-1000 ease-in-out ${
